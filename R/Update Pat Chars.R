...
#'@param population_ is the population matrix
#'@param alive_ is a TRUE/FALSE vector indicating if the patient is alive at the start of the year
#'@param alive_ is the underling trajectory of BMI for each patient
#'@param SBP_underlying_ is the underling trajectory of systolic blood pressure 
#'for each patient
#'@param HDL_underlying_ is the underlying trajectory of HDL cholesterol for each 
#'patient
...
update_history_MtHood2025C1 <- function(population_,
                                        alive_,
                                        A1c_,
                                        BMI_,
                                        SBP_,
