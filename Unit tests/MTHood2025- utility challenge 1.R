...
nocomps_notoverweight <- calculate_QALYs_MtHood2025_C1(popM,
                                                    0,
                                                    T,
                                                    GlobalVars)
...
nocomps_BMI26 <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T,
                                            GlobalVars)
...
nocomps_BMI27 <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T,
                                            GlobalVars)
...
blindthisyear <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T,
                                            GlobalVars)
...
blindlastyear <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T,
                                            GlobalVars)
...
MMALBthisyear <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T,
                                            GlobalVars)
...
MMALBlastyear <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T,
                                            GlobalVars)
...
RENALthisyear <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T, 
                                            GlobalVars)
...
RENALnextyear <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T, 
                                            GlobalVars)
#Weights are from pg3, https://www.ukkidney.org/sites/default/files/UK%20Renal%20Registry%20Annual%20Report%202022%20Patient%20Summary.pdf
...
PVDthisyear <- calculate_QALYs_MtHood2025_C1(popM,
                                            0,
                                            T, 
                                            GlobalVars)
...
PVDnextyear <- calculate_QALYs_MtHood2025_C1(popM,
                                          0,
                                          T, 
                                          GlobalVars)
...
ulceryear <- calculate_QALYs_MtHood2025_C1(popM,
                                        0,
                                        T, 
                                        GlobalVars)
...
ulcerhist <- calculate_QALYs_MtHood2025_C1(popM,
                                        0,
                                        T, 
                                        GlobalVars)
...
ampevent <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
...
amphist <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
...
amp2event <- calculate_QALYs_MtHood2025_C1(popM,
                                        0,
                                        T, 
                                        GlobalVars)
...
amp2hist <- calculate_QALYs_MtHood2025_C1(popM,
                                        0,
                                        T, 
                                        GlobalVars)
#If an amputation history, PVD decrements should still apply
...
stroevent <- calculate_QALYs_MtHood2025_C1(popM,
                                        0,
                                        T, 
                                        GlobalVars)
...
strohist <- calculate_QALYs_MtHood2025_C1(popM,
                                        0,
                                        T, 
                                        GlobalVars)
...
stro2event <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
...
stro2hist <- calculate_QALYs_MtHood2025_C1(popM,
                                         0,
                                         T, 
                                         GlobalVars)
...
MI1event <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
...
MI1hist <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
...
MI2event <- calculate_QALYs_MtHood2025_C1(popM,
                                      0,
                                      T, 
                                      GlobalVars)
...
MI2hist <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
...
IHDevent <- calculate_QALYs_MtHood2025_C1(popM,
                                      0,
                                      T, 
                                      GlobalVars)
...
IHDhist <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
...
CHFevent <- calculate_QALYs_MtHood2025_C1(popM,
                                      0,
                                      T, 
                                      GlobalVars)
...
CHFhist <- calculate_QALYs_MtHood2025_C1(popM,
                                       0,
                                       T, 
                                       GlobalVars)
